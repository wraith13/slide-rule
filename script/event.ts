...
export const initialize = () =>
{
    ...
    bindCommandToButton(UI.addSquareRootLaneButton, () => Command.addLane({ type: "root", exponent: 2 }));
    bindCommandToButton(UI.addCubeRootLaneButton, () => Command.addLane({ type: "root", exponent: 3 }));
    bindCommandToButton(UI.addExponentialLaneButton, () => Command.addLane({ type: "exponential", base: "e" }));
    bindCommandToButton(UI.addExponential2LaneButton, () => Command.addLane({ type: "exponential", base: 2 }));
    bindCommandToButton(UI.addExponential10LaneButton, () => Command.addLane({ type: "exponential", base: 10 }));
    bindCommandToButton(UI.addLogarithmicLaneButton, () => Command.addLane({ type: "logarithmic", base: "e" }));
    bindCommandToButton(UI.addLogarithmic2LaneButton, () => Command.addLane({ type: "logarithmic", base: 2 }));
    bindCommandToButton(UI.addLogarithmic10LaneButton, () => Command.addLane({ type: "logarithmic", base: 10 }));
    ...
    bindCommandToButton(UI.addSecantLaneButton, () => Command.addLane({ type: "secant" }));
    bindCommandToButton(UI.addCosecantLaneButton, () => Command.addLane({ type: "cosecant" }));
    bindCommandToButton(UI.addCotangentLaneButton, () => Command.addLane({ type: "cotangent" }));
    bindCommandToButton(UI.addArcsineLaneButton, () => Command.addLane({ type: "arcsine" }));
    bindCommandToButton(UI.addArccosineLaneButton, () => Command.addLane({ type: "arccosine" }));
    bindCommandToButton(UI.addArctangentLaneButton, () => Command.addLane({ type: "arctangent" }));
    bindCommandToButton(UI.addArcsecantLaneButton, () => Command.addLane({ type: "arcsecant" }));
    bindCommandToButton(UI.addArccosecantLaneButton, () => Command.addLane({ type: "arccosecant" }));
    bindCommandToButton(UI.addArccotangentLaneButton, () => Command.addLane({ type: "arccotangent" }));
