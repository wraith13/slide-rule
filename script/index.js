...
define("script/model", ["require", "exports", "script/number", "script/type", "script/url", "resource/config"], function (require, exports, number_1, type_1, url_1, config_json_1) {
    ...
    (function (Model) {
        ...
        Model.getAllLanes = function () {
            return Model.data.slides.reduce(function (allLanes, slide) { return allLanes.concat(slide.lanes); }, []);
        };
        ...
        Model.makeSlide = function (anchor) {
        ...
        Model.makeSureSlide = function () {
            if (Model.data.slides.length <= 0) {
                Model.data.slides.push(Model.makeSlide());
            }
            return Model.data.slides[Model.data.slides.length - 1];
        };
        Model.addLane = function (lane) {
            Model.makeSureSlide().lanes.push(lane);
        };
        var getLaneName = function (laneSeed) {
            var _loop_1 = function (i) {
                var preset = config_json_1.default.model.lane.presets[i];
                if (Model.data.slides.every(function (slide) { return slide.lanes.every(function (lane) { return lane.name !== i; }); }) &&
        ...
        Model.makeLane = function (laneSeed) {
            return ({
                type: laneSeed.type,
        ...
        Model.remove = function (index) {
            var i = 0;
            for (var _i = 0, _a = Model.data.slides; _i < _a.length; _i++) {
                var slide = _a[_i];
            ...
            throw new Error("\uD83E\uDD8B FIXME: Model.remove: index out of range: ".concat(index));
        };
        Model.initialize = function () {
            var _a;
            Model.data.anchor = (_a = number_1.Number.parse(url_1.Url.get("anchor"))) !== null && _a !== void 0 ? _a : 100;
            console.log("Model initialized: anchor=".concat(Model.data.anchor));
        };
    })(Model || (exports.Model = Model = {}));
});
define("script/view", ["require", "exports", "script/number", "script/type", "script/url", "script/ui", "resource/config"], function (require, exports, number_2, type_2, url_2, ui_1, config_json_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.View = void 0;
    ...
    (function (View) {
        ...
        View.initialize = function () {
            ...
            View.setViewMode((_c = (_a = url_2.Url.get("view-mode")) !== null && _a !== void 0 ? _a : (_b = config_json_2.default.view) === null || _b === void 0 ? void 0 : _b.defaultViewMode) !== null && _c !== void 0 ? _c : "ruler");
            View.setScaleMode((_f = (_d = url_2.Url.get("scale-mode")) !== null && _d !== void 0 ? _d : (_e = config_json_2.default.view) === null || _e === void 0 ? void 0 : _e.defaultScaleMode) !== null && _f !== void 0 ? _f : "logarithmic");
            View.data.viewScale = (_g = number_2.Number.parse(url_2.Url.get("view-scale"))) !== null && _g !== void 0 ? _g : 1;
            View.data.baseOfLogarithm = (_l = (_h = number_2.Number.orUndefined(type_2.Type.getNamedNumberValue(url_2.Url.get("base")))) !== null && _h !== void 0 ? _h : (_k = (_j = config_json_2.default.view) === null || _j === void 0 ? void 0 : _j.baseOfLogarithm) === null || _k === void 0 ? void 0 : _k.default) !== null && _l !== void 0 ? _l : 10;
